...
//
//        modelAndView.addObject("book", medicineService.getBookById(id));
...
//
//        MedicineEntity book= medicineService.getBookById(id);
...
//        );
//
//        medicineService.decreaseBookStockCount(book);
//
